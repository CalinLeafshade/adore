...
function adore.run(args)
	...
	require("adore.mask")
	require("adore.persist")
	require("adore.ui")
	require('adore.palette')
	require("adore.util")
	require("adore.shaders")
	require("adore.bloom")
	require("adore.overlays")
	require("adore.graphics")
	require("adore.camera")
	require("adore.mouse")
	require("adore.animation")
	require("adore.nodemap")
	require("adore.path")
	require("adore.actors")
	require("adore.scenes")
	require("adore.inventories")
	require("adore.items")
	require("adore.math")
